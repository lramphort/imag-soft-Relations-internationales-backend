...
} elseif( !empty($_GET['idCourse']) && !empty($_GET['idPerson']) && !empty($_GET['etat']) ) {
	$requete = $pdo->prepare("SELECT * FROM `Poll` WHERE `idCourse` LIKE :idCourse AND `idPerson` LIKE :idPerson AND `etat` LIKE :etat");
