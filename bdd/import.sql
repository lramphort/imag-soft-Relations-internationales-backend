...
Insert into Student values ('1', 'UGA', false, false);
Insert into Student values ('2', 'UGA', false, false);
Insert into Student values ('3','UGA', false, true);
Insert into Student values ('4','UPMF', true, false);
Insert into Student values ('5', 'UPMF', false, false);
Insert into Student values ('6', 'ENSIMAG', true, false);
Insert into Student values ('7','UJF', false, false);
Insert into Student values ('8', 'UPMF', true, false);
Insert into Student values ('9', 'UGA', false, false);
Insert into Student values ('10', 'UGA', true, false);
Insert into Student values ('11', 'Jean-Moulin', true, true);
Insert into Student values ('12', 'UPMF', true, false);
...
Insert into Mark values ('1', '1','QCM', 8.5);
Insert into Mark values ('2', '1','CC', 15);
Insert into Mark values ('3', '1','CC', 10);
Insert into Mark values ('4', '2','DM', 6.5);
Insert into Mark values ('5', '2','Examen', 19);
Insert into Mark values ('6', '2','Partiel', 11);
Insert into Mark values ('7', '3','Partiel', 15);
Insert into Mark values ('8', '3','CC', 3);
Insert into Mark values ('9', '3','QCM', 12.5);
